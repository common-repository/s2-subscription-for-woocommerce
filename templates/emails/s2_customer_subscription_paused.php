...
/**
 * This is the email sent to the customer when his subscription has been paused
 *
...
<p><?php printf( esc_html( __( 'Subscription #%d has been paused', 's2-subscription' ) ), esc_html( $subscription->id ) ); ?></p>
